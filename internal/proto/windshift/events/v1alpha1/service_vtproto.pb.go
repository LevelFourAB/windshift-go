...
func (m *EnsureStreamRequest_RetentionPolicy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DiscardPolicy != nil {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(*m.DiscardPolicy))
		i--
		dAtA[i] = 0x28
	}
	if m.MaxBytes != nil {
	...
	if m.MaxEventsPerSubject != nil {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(*m.MaxEventsPerSubject))
		i--
		dAtA[i] = 0x18
	}
	if m.MaxEvents != nil {
	...
	if m.MaxAge != nil {
		size, err := (*durationpb.Duration)(m.MaxAge).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EnsureStreamRequest_StreamSource) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FilterSubjects) > 0 {
		for iNdEx := len(m.FilterSubjects) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FilterSubjects[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *EnsureStreamRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MaxEventSize != nil {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(*m.MaxEventSize))
		i--
		dAtA[i] = 0x40
	}
	if m.DeduplicationWindow != nil {
		size, err := (*durationpb.Duration)(m.DeduplicationWindow).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EnsureConsumerRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ProcessingTimeout != nil {
		size, err := (*durationpb.Duration)(m.ProcessingTimeout).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if len(m.Stream) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Stream)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *PublishEventRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ExpectedLastId != nil {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(*m.ExpectedLastId))
		i--
		dAtA[i] = 0x28
	}
...
func (m *EventsRequest_Subscribe) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.MaxProcessingEvents != nil {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(*m.MaxProcessingEvents))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Consumer) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Consumer)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Stream) > 0 {
...
func (m *EventsRequest_Reject) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Delay != nil {
		size, err := (*durationpb.Duration)(m.Delay).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Headers) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TraceParent != nil {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(*m.TraceParent)))
		i--
		dAtA[i] = 0x1a
	}
	if m.IdempotencyKey != nil {
...
func (m *EnsureStreamRequest_RetentionPolicy) SizeVT() (n int) {
	...
	_ = l
	if m.MaxAge != nil {
		l = (*durationpb.Duration)(m.MaxAge).SizeVT()
	...
	if m.MaxEventsPerSubject != nil {
		n += 1 + protohelpers.SizeOfVarint(uint64(*m.MaxEventsPerSubject))
	}
	if m.MaxBytes != nil {
		n += 1 + protohelpers.SizeOfVarint(uint64(*m.MaxBytes))
	}
	if m.DiscardPolicy != nil {
		n += 1 + protohelpers.SizeOfVarint(uint64(*m.DiscardPolicy))
	}
	if m.DiscardNewPerSubject != nil {
		n += 2
	}
...
func (m *EnsureStreamRequest) SizeVT() (n int) {
	...
	if m.DeduplicationWindow != nil {
		l = (*durationpb.Duration)(m.DeduplicationWindow).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.MaxEventSize != nil {
		n += 1 + protohelpers.SizeOfVarint(uint64(*m.MaxEventSize))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *EnsureConsumerRequest) SizeVT() (n int) {
	...
	if m.ProcessingTimeout != nil {
		l = (*durationpb.Duration)(m.ProcessingTimeout).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *PublishEventRequest) SizeVT() (n int) {
	...
	if m.ExpectedLastId != nil {
		n += 1 + protohelpers.SizeOfVarint(uint64(*m.ExpectedLastId))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *EventsRequest_Subscribe) SizeVT() (n int) {
	...
	if m.MaxProcessingEvents != nil {
		n += 1 + protohelpers.SizeOfVarint(uint64(*m.MaxProcessingEvents))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *EnsureStreamRequest_RetentionPolicy) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.MaxAge == nil {
				m.MaxAge = &durationpb1.Duration{}
			}
			if err := (*durationpb.Duration)(m.MaxAge).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *EnsureStreamRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.DeduplicationWindow == nil {
				m.DeduplicationWindow = &durationpb1.Duration{}
			}
			if err := (*durationpb.Duration)(m.DeduplicationWindow).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
...
func (m *EnsureConsumerRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.ProcessingTimeout == nil {
				m.ProcessingTimeout = &durationpb1.Duration{}
			}
			if err := (*durationpb.Duration)(m.ProcessingTimeout).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EventsRequest_Reject) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Delay == nil {
				m.Delay = &durationpb1.Duration{}
			}
			if err := (*durationpb.Duration)(m.Delay).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 3:
			...
			if oneof, ok := m.Pointer.(*StreamPointer_Time); ok {
				if err := (*timestamppb.Timestamp)(oneof.Time).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
